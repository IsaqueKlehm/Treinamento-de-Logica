...
# mas ainda precisa fazer ajustes na lista de convidados. Camila quer adicionar 
# novos nomes e organizá-los em posições específicas.

# Como você criaria um programa que mostre a lista inicial, permita a inserção de 
# um novo nome em uma posição escolhida e exiba a lista atualizada?
