...
# Cada categoria contém uma lista de dicionários representando as vendas individuais, 
# com informações sobre o produto, a quantidade vendida e o valor unitário. 
...
# print(vendas["Eletrodomésticos"][1]['quantidade'])
