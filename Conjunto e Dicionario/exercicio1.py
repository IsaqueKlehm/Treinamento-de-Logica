...
# Ela gostaria que o programa solicitasse o nome dos convidados e, ao final, 
# exibisse a lista organizada sem repetições.

# Escreva um programa que receba os nomes dos convidados até que o usuário digite 'sair', 
# e ao final mostre a lista de convidados sem repetições.
